...
def test_can_add_bike_too_race():
    race = Race(300)
    bike = Bike(1)
    race.add_bike(bike)
...
def test_can_add_bikes_too_race():
    race = Race(300)
    bike1 = Bike(1)
    bike2 = Bike(1)
    bike3 = Bike(1)
...
def test_will_announce_winner_correctly_if_they_are_past_finished_line():
    race = Race(50)
    bike1 = Bike(4)
    bike2 = Bike(7)
    bike3 = Bike(5)
